...
from .views import register_customer,register_wallet,register_account,register_transaction,register_receipt,register_loan,register_reward,register_notification,register_thirdparty,register_card,list_customers,list_accounts,list_reciepts,list_loans,list_rewards,list_notifications,list_thirdpartys,list_cards,list_wallets
